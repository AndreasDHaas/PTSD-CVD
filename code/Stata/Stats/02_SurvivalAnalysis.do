***  Survival analysis 
	...
	* Table 2: Unadjusted and adjusted hazards ratios for factors associated with major cardiovascular events  
		...
		* AnalyseSurv table 
			use patient start18 end sex popgrp age year ptsd1_y_tvc othanx1_y_tvc org1_y_tvc su1_y_tvc psy1_y_tvc mood1_y_tvc omd1_y_tvc mve2_y_tvc cod2 death_y_tvc ///
				dm1_y_tvc dl1_y_tvc hiv1_y_tvc ht1_y_tvc mve2_d ptsd1_d using "$clean/analyseSurv", clear	
		...
		* Stset 
			...
			listif patient start18 end ptsd1_d ptsd1_y_tvc mve2_y_tvc mve2_d _t0 _t _d _st if mve2_y_tvc ==1 & ptsd1_d!=., sepby(patient) id(patient) sort(patient start18) n(10) nolab
	...
	* Table 3: Unadjusted and adjusted hazards ratios for factors associated with major cardiovascular events: moderate level of certainty 
		...
		* Stset 
			stset end, failure(mve2_y_tvc) origin(time start18) id(patient) scale(365.25)  
			listif patient start18 end ptsd1_d ptsd1_y_tvc mve2_y_tvc mve2_d _t0 _t _d _st if mve2_y_tvc ==1 & ptsd1_d!=., sepby(patient) id(patient) sort(patient start18) n(1) nolab
		...
		* Model 3: adjusted for PTSD, sociodemographic characteristics, year and CVD risk factors and HIV 
			stcox i.ptsd2_y_tvc ib3.age ib2.sex i.year i.popgrp i.dm1_y_tvc i.dl1_y_tvc i.ht1_y_tvc i.hiv1_y_tvc  
			...
			dropcoef(0b.ptsd2_y_tvc 0b.dm1_y_tvc 0b.dl1_y_tvc 0b.ht1_y_tvc 0b.hiv1_y_tvc ///
			h.dm1_y_tvc h.dl1_y_tvc h.ht1_y_tvc h.hiv1_y_tvc ) sort(number0 id0)		

		* Model 4: adjusted for PTSD, sociodemographic characteristics, year, psychiatric comorbidity, CVD risk factors and HIV 
			stcox i.ptsd2_y_tvc ib3.age ib2.sex i.year i.popgrp i.othanx2_y_tvc i.org2_y_tvc i.su2_y_tvc i.psy2_y_tvc i.mood2_y_tvc i.omd2_y_tvc i.dm1_y_tvc i.dl1_y_tvc i.ht1_y_tvc i.hiv1_y_tvc  
			...
			dropcoef(0b.ptsd2_y_tvc 0b.othanx2_y_tvc 0b.org2_y_tvc 0b.su2_y_tvc 0b.psy2_y_tvc 0b.mood2_y_tvc 0b.omd2_y_tvc 0b.dm1_y_tvc 0b.dl1_y_tvc 0b.ht1_y_tvc 0b.hiv1_y_tvc ///
			h.othanx2_y_tvc h.org2_y_tvc h.su2_y_tvc h.psy2_y_tvc h.mood2_y_tvc h.omd2_y_tvc h.dm1_y_tvc h.dl1_y_tvc h.ht1_y_tvc h.hiv1_y_tvc ) sort(number0 id0)				
