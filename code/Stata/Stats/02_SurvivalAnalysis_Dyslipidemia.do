*Survival analysis 
	...
	* Table 2: Unadjusted and adjusted hazards ratios for factors associated with dyslipidemia: low certainty 
		...
		* Univariable analysis 
			...
			stcox i.ht1_y_tvc
			regtable ht1_y_tvc, number(7) append("$temp/hrMACE") varsuffix(0) keep(var est label id number) dropcoef(0b.ht1_y_tvc)	
			stcox i.hiv1_y_tvc 
		...
		* Model 1: adjusted for PTSD, sociodemographic characteristics and year 
			...
			* Model 4: adjusted for PTSD, sociodemographic characteristics, year, psychiatric comorbidity, CVD risk factors and HIV 
			stcox i.ptsd1_y_tvc ib3.age ib2.sex i.year i.popgrp i.su1_y_tvc i.psy1_y_tvc i.mdd1_y_tvc i.anx1_y_tvc i.sleep1_y_tvc i.dm1_y_tvc i.ht1_y_tvc i.hiv1_y_tvc  
			regtable ptsd1_y_tvc age sex year popgrp su1_y_tvc psy1_y_tvc mdd1_y_tvc anx1_y_tvc sleep1_y_tvc dm1_y_tvc ht1_y_tvc hiv1_y_tvc, ///
			heading number(0) merge("$temp/hrMACE") varsuffix(4) estlab("aHR (95% CI)") keep(var est label) ///
			dropcoef(0b.ptsd1_y_tvc 0b.su1_y_tvc 0b.psy1_y_tvc 0b.mdd1_y_tvc 0b.anx1_y_tvc 0b.sleep1_y_tvc 0b.dm1_y_tvc 0b.ht1_y_tvc 0b.hiv1_y_tvc ///
			h.su1_y_tvc h.psy1_y_tvc h.mdd1_y_tvc h.anx1_y_tvc h.sleep1_y_tvc h.dm1_y_tvc h.ht1_y_tvc h.hiv1_y_tvc ) sort(number0 id0)		
