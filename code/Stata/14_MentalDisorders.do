*** Mental disorders 
	...
	fdiag anx1 using "$clean/ICD10_F" if regexm(icd10_code, "F4"), y mindate(`=d(01/01/2011)') maxdate(`=d(01/07/2020)') label("Anxiety disorder") censor(end) 
...
* Add recoded depression variable for descriptive tables: depression==1, no depression==2
	gen ptsd = 2-ptsd1_y 
	lab define dep 1 "PTSD" 2 "No PTSD", replace
	lab val ptsd ptsd
	tab ptsd ptsd1_y
