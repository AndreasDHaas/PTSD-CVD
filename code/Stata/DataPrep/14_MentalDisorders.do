...
* Version 1: low certainty 
	...
	* Variable labels
		foreach d in mhd org su psy mood anx omd alc drug tobacco bp dep omood panic gad ad uad asr ptsd adj oad othanx sleep nos sd {
			...
			else if "`d'" == "nos" local t "non-organic sleep disorder (low certainty)" 
			else if "`d'" == "sd" local t "sleep disorder (G47) (low certainty)" 
...
* Version 2: medium certainty
	...
	* Generate variables and assign value labels 
		foreach var in org su psy mood anx omd ptsd othanx sleep alc drug tobacco bp dep omood panic gad ad uad asr adj oad nos sd {
	...
	* Variable labels 
		foreach d in org su psy mood anx omd ptsd othanx sleep alc drug tobacco bp dep omood panic gad ad uad asr adj oad nos sd  {
			...
			else if "`d'" == "nos" local t "non-organic sleep disorder (moderate certainty)" 
			else if "`d'" == "sd" local t "sleep disorder (G47) (moderate certainty)" 
